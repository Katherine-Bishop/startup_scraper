class EducationsController < ApplicationController
  ...
  def scrape
    ...
    @founders.each do |founder|
      ...
      schools = linkedinProfile.search("dd.summary-education ul li a")

      schools.each do |school|
        @education = Education.new
        @education.founder_id = founder.id
        @education.school = school.text
        @education.save
      end 
    end   
  end 
  ...
  private
    ...
    def education_params
      params.require(:education).permit(:founder_id, :school)
    end
end
